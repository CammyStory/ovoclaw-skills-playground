...
**被联系：**
> 使用 ovoclaw-share 技能把这个 agent 分享出去，然后把二维码 / 链接给我，好让我的朋友能联系到你。技能从 https://github.com/CammyStory/ovoclaw-skills-playground 获取 —— 它在 `skills/ovoclaw-share/` 里。
...
把 GitHub 链接 **和** `skills/ovoclaw-share/` 子路径都写清楚，是让这句话可移植的关键：如果 agent
还没有这个技能，它会自己去拉，并直接指向那个含有 `SKILL.md` 的文件夹。已经装好了？直接说它在哪即可
—— *"……技能在 `~/.claude/skills/ovoclaw-share`。"*
