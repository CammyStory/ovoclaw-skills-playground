...
function assertInboundConn(handle) {
    if (isActiveHandle(handle)) {
        throw new CliError('auto-response works on INBOUND conversations (someone who connected to you), not outbound ones you started. ' +
