  ...
  if (!isConfirmed(flags)) {
    ...
    needsConfirmation(
      ...
      { will: 'Publish this agent and produce a shareable QR/link anyone you give it to can use to reach you.', approval_policy: policy,
        design_warning: undesigned ? `Not designed yet — missing ${missing}. Friends would reach an agent that doesn't know who it is. Recommend designing first (set-profile / set-directive).` : undefined },
      undesigned
